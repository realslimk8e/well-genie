...
export default function SummaryCard({ title, value, unit, hint, accent="blue" }: Props) {
  return (
    <div className="card card-compact bg-base-100 border border-base-300 rounded-2xl">
