...
type NavKey = "overview" | "sleep" | "diet" | "exercise" | "chatbot" | "settings" | "import";
...
className={`w-full text-left flex items-center gap-3 p-3 rounded-xl transition-colors ${active ? "bg-base-200" : "hover:bg-base-200"}`}
