        ...
        <div className="flex flex-col h-full p-4">
            <div className="flex-grow overflow-y-auto">
                <div className="chat chat-start">
                    <div className="chat-image avatar">
                        <div className="w-10 rounded-full">
                            <img src="https://api.dicebear.com/9.x/thumbs/svg?seed=Felix" alt="avatar"/>
                        </div>
                    </div>
                ...
                <div className="chat chat-end">
                    <div className="chat-image avatar">
                        <div className="w-10 rounded-full">
                            <img src="https://api.dicebear.com/9.x/thumbs/svg?seed=Aneka" alt="avatar"/>
                        </div>
                    </div>
                    <div className="chat-header">
                        You
                    ...
                    <div className="chat-bubble chat-bubble-primary">Review my sleep data for this month</div>
                    <div className="chat-footer opacity-50">
                        Seen at 12:46
                    </div>
                </div>
