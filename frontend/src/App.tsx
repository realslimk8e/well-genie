              ...
              <section className="mt-4 grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <ListPercentTile
                  ...
                  rows={[
                    {
                      label: "Protein",
                      value: Math.min(100, Math.round((avgProtein * 4 / (avgCals || 1)) * 100)),
                    },
                    {
                      label: "Fat",
                      value: Math.min(100, Math.round((avgFat * 9 / (avgCals || 1)) * 100)),
                    },
                    {
                      label: "Carbs",
                      value: Math.min(100, Math.round((avgCarbs * 4 / (avgCals || 1)) * 100)),
                    },
                  ]}
                />
                <BannerTile />
